# SISTEMA DE CAPTURA DE LEADS — LUMMÉ
...
O sistema de captura da Lummé funciona em 3 camadas:
...
Subtítulo: "A Lummé transforma o nível do seu trabalho em captação digital previsível — com metodologia própria e KPIs documentados."
...
```
"A Lummé tem um sistema. Não é post bonito — é estratégia com método."
[Explicação dos 4 Layers com ícones]
```

**Seção 4 — Para quem é**
```
"A Lummé atende profissionais que valorizam resultado:"
...
→ A metodologia dos 4 Layers (usada pela Lummé com clientes reais)
...
💼 Serviços da Lummé → [Site principal]
...
*Lummé — Sistema de Captura de Leads v1.0 — Maio 2026*
